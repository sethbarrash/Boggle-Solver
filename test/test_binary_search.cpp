...
int main() {
  ...
  char boston     [MAX_WORD_LENGTH] = "Boston";
  ...
  assert(binary_search(a, baltimore, 5)  == 0);
  assert(binary_search(a, chicago, 5)    == 1);
  assert(binary_search(a, cleveland, 5)  == 2);
  assert(binary_search(a, new_york, 5)   == 3);
